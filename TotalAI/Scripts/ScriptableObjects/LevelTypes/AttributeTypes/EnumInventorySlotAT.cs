...
namespace TotalAI
{
    [CreateAssetMenu(fileName = "EnumInventorySlotAT", menuName = "Total AI/Level Types/Attribute Types/Enum InventorySlot", order = 0)]
    public class EnumInventorySlotAT : EnumAT
    {
        [Header("Possible values for this enum AttributeType")]
        public InventorySlot[] options;
        ...
        {
            return options.Select(x => x.name).ToArray();
        }
